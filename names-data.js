/* names-data.js — v9.7: ランダム生成用の名前データ（app.jsから分離） */
/* ══════════════════════════════════════════════════════════════════
   ランダム生成データ — 名前配列（×5 拡張済み）
   ──────────────────────────────────────────────────────────────────
   このファイルは生徒のランダム生成に使う姓・名のリストです。
   姓: SURNAMES_MAJOR（よくある姓）、SURNAMES_RARE（珍しい姓）
   名: MALE_NAMES（男性名）、FEMALE_NAMES（女性名）
   genStudentName() で 2:1 の重みづけ（よくある姓 2/3、珍しい姓 1/3）で
   ランダムに組み合わせて使います。
══════════════════════════════════════════════════════════════════ */
/* ── 姓データ: MAJOR（一般的な姓）と RARE（珍しい姓）に分割 ──
   合計数は約1.5倍。選択時の重み: MAJOR=2/3、RARE=1/3 */
